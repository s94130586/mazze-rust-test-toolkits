...
for example:
    - Get epoch number:     python3 rpc_client_http.py mazze_epochNumber
    - Get last mined epoch: python3 rpc_client_http.py mazze_epochNumber latest_mined
    - Specify RPC URL:      python3 rpc_client_http.py http://localhost:8888 mazze_epochNumber
