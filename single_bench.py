...
'''
mazze.config.default_config["GENESIS_STATE_ROOT"] = decode_hex("0xfc15d1092924af317a05f1a14519d5a2f4b1bf02be3abf4ea6f3d861a814a45f")
from mazze.utils import convert_to_nodeid, priv_to_addr, parse_as_int, encode_hex
...
class SingleBench(MazzeTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        self.rpc_timewait = 600
        # The file can be downloaded from `https://s3-ap-southeast-1.amazonaws.com/mazze-test/genesis_secrets.txt`
    ...
    def run_test(self):
        ...
        genesis = self.node.mazze_getBlockByEpochNumber("0x0", False)["hash"]
        n_connections = 4
        p2p_connections = []
